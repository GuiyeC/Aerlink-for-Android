...
public class NotificationDataManager {
    ...
    private static final int IC_LINE = R.drawable.ic_line;
    private static final int IC_TWITTER = R.drawable.ic_twitter;
    private static final int IC_GMAIL = R.drawable.ic_gmail;
    private static final int IC_WHATSAPP = R.drawable.ic_whatsapp;
    private static final int IC_MAIL = R.drawable.ic_mail;
    private static final int IC_CALENDAR = R.drawable.ic_calendar;
    ...
    private static final int IC_INSTAGRAM = R.drawable.ic_instagram;
    ...
    public static void updateData(NotificationData notificationData) {
        ...
        switch (notificationData.getAppId()) {
            ...
            case "com.burbn.instagram":
                notificationData.setAppIcon(IC_INSTAGRAM);
                //notificationData.setBackgroundColor(Color.rgb(1, 83, 128));
